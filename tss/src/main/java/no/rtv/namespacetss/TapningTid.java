 ...
 * 
 * <p>Java class for TapningTid complex type</p>.
 * 
...
public class TapningTid {
     ...
     * This is why there is not a {@code set} method for the apningsTid property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the apningsTid property.
     */
    public List<TapningTid.ApningsTid> getApningsTid() {
        if (apningsTid == null) {
            apningsTid = new ArrayList<>();
        }
