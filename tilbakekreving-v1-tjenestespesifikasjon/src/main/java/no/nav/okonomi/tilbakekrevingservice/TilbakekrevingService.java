...
public class TilbakekrevingService extends Service {
    ...
    public final static QName SERVICE = new QName("http://okonomi.nav.no/tilbakekrevingService/", "TilbakekrevingService");
    public final static QName TilbakekrevingServicePort = new QName("http://okonomi.nav.no/tilbakekrevingService/", "TilbakekrevingServicePort");
    static {
